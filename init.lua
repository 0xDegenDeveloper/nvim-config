...
vim.api.nvim_set_keymap('n', '<leader>w|', '<cmd>vsplit<CR>', { noremap = true, silent = true, desc = "Vertical Split" })
vim.api.nvim_set_keymap('n', '<leader>wv', '<cmd>vsplit<CR>', { noremap = true, silent = true, desc = "Vertical Split" })

-- Add keybinding for horizontal split
vim.api.nvim_set_keymap('n', '<leader>w-', '<cmd>split<CR>', { noremap = true, silent = true, desc = "Horizontal Split" })
vim.api.nvim_set_keymap('n', '<leader>ws', '<cmd>split<CR>', { noremap = true, silent = true, desc = "Horizontal Split" })

-- Add a keybinding to toggle terminal with Ctrl+"-" with description
vim.api.nvim_set_keymap('t', '<C-_>', [[<C-\><C-n>:lua Snacks.terminal.toggle()<CR>]], { noremap = true, silent = true, desc = "Toggle Terminal" })
